(async () => {
    ...
    s4d.client.on('messageCreate', async (s4dmessage) => {
        if ((/\d/.test((s4dmessage.content)))) {
            https.get(('https://lms.cgit.pk/api.php?action=discord_action&data_string=' + String(s4dmessage.content)), async resp => {
                    let data2 = "";
                    ...
                    resp.on("end", async () => {
                        ...
                        s4dmessage.channel.send((data.msg));
